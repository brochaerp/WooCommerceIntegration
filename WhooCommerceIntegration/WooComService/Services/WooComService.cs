...
namespace WooComService
{
    public partial class WooComService : ServiceBase
    {
        ...
        private void LogError(object sender, ExceptionEventArgs ex)
        {
            ...
            try
            {
                ...
                BugReport.Submit("https://erpinterface.fogbugz.com/scoutSubmit.asp", "Quality Assurance", "WooComService", "Code", "Sruli@ErpInterface.com", false, defaultMsg, ex.PassedException, true, "{0}.{1}.{2}.{3}", true);
            }
            catch (Exception e)
            {
        ...
        protected override void OnStart(string[] args)
        {
            try
            {
                ...
                bool acclamareStarted = acclamare.StartAcclamare(companyName, connectionString, user, pass);
        ...
        private void PollControllers(bool stopPolling = false)
        {
